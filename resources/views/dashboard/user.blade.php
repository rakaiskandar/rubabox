                ...
                <div class="modal-body">
                    <form action="{{ route('user.store')}}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" aria-describedby="helpId" placeholder="Type user name..." >
                            @error('name')
                            <span class="invalid-feedback" role="alert">
                                <strong>{!!$message!!}</strong>
                            </span>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('username') is-invalid @enderror" name="username" id="username" aria-describedby="helpId" placeholder="Type username for account...">
                            @error('username')
                            <span class="invalid-feedback" role="alert">
                                <strong>{!!$message!!}</strong>
                            </span>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" id="email" aria-describedby="helpId" placeholder="Type user email">
                            @error('email')
                            <span class="invalid-feedback" role="alert">
                                <strong>{!!$message!!}</strong>
                            </span>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control @error('password') is-invalid @enderror" name="password" id="password" aria-describedby="helpId" placeholder="Type user password...">
                            @error('password')
                            <span class="invalid-feedback" role="alert">
                                <strong>{!!$message!!}</strong>
                            </span>
    ...
    <div class="wrapper">
        ...
        <div class="dashboard-content">
            ...
            <div class="content-header">
                <div class="col-4 title-subsi">User Overview</div>
                <div class="col-4 subtitle-subsi">Manage Your User</div>
            </div>

            <div class="total-add-box">
                <div class="total-box-e">
                    <p class="col-8 title-us">Total User</p>
                    <h2 class="col-2 total-us">{{ $total->count() }}</h2>
                </div>
                <div class="add-box">
                    <p class="col-8 title-ab">Add User</p>
                    ...
                    <table class="table table-hover table-light">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>{{ $row->email }}</td>
                                <td>
                                    <a href="{{ url('/edit/user',$row->id)}}" class="btn btn-warning">Edit</a>
                                    <a href="{{ url('/delete/user',$row->id )}}" class="btn btn-danger">Delete</a>
                                </td>
                            </tr>
                        </tbody>
                        @endforeach
